...
* **Agent Classification:** Populating the worlds with specific agent types:
    * *Monolinguals / Native Hosts:* Agents fixed to a single primary language (L1 in World 1, L2 in World 2).
    * *Bilingual Immigrants:* Agents equipped with a dual vocabulary, migrating from World 1 to World 2.
