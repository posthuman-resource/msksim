...
export { NeighborhoodType, TopologyConfig } from './topology';
export type {
...
export { BatchConfig, SweepConfig } from './batch';
export type { BatchConfig as BatchConfigType, SweepConfig as SweepConfigType } from './batch';
